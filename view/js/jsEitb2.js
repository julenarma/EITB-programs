...
function cargarUltimasNoticiasEitb1() {
  ...
  fetch("https://hodeia.eitb.eus/datuak/json/parrilla/last7days/canal2_ETB2HD.json") 
    ...
    .then(res => res.json()).then(result => {
        ...
        noticia += "</div>";
          ...
          if (tiempo==true) {
            ...
            setInterval(function() {
                $.getJSON("https://hodeia.eitb.eus/datuak/json/parrilla/last7days/canal2_ETB2HD.json", function(json) {
      ...
      $(".noticia_directo").click(function () {
        ...
        $("#videos").show();
        var videoSrc = "//live-dvr.eitb-fastly.cross-media.es/live-content/etb2hd-hls/master.m3u8?start="+myEpochStart;
      ...
      $(".noticias_pasadas").click(function () {
        ...
        var video = document.getElementById('video');
        $("#videos").show();
         var videoSrc = "//live-dvr.eitb-fastly.cross-media.es/live-content/etb2hd-hls/master.m3u8?start="+myEpochStart +"&end=" +myEpochEnd;
