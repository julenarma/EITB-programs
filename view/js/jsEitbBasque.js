...
function cargarUltimasNoticiasEitb1() {
  ...
  fetch("https://hodeia.eitb.eus/datuak/json/parrilla/last7days/canal6_EITBBASQUE.json") 
    ...
    .then(res => res.json()).then(result => {
      ...
      var horas = new Date(noticias[i].onairdate).toLocaleTimeString('es', { hour: 'numeric', minute: 'numeric', second:'numeric' });
        ...
        noticia += "</div>";
          ...
          if (tiempo==true) {
            ...
            setInterval(function() {
                $.getJSON("https://hodeia.eitb.eus/datuak/json/parrilla/last7days/canal6_EITBBASQUE.json", function(json) {
      ...
      $(".noticia_directo").click(function () {
        ...
        var myEpochStart = start_directo/1000;
        var myEpochEnd = end_directo/1000;
        var video = document.getElementById('video');
        $("#videos").show();
        var videoSrc = "//live-dvr.eitb-fastly.cross-media.es/live-content/eitbbasque-hls/master.m3u8?start="+myEpochStart;
      ...
      $(".noticias_pasadas").click(function () {
        ...
        var video = document.getElementById('video');
        $("#videos").show();
         var videoSrc = "//live-dvr.eitb-fastly.cross-media.es/live-content/eitbbasque-hls/master.m3u8?start="+myEpochStart +"&end=" +myEpochEnd;
    ...
    if (directo!=null) {
      window.location.href="#zuzenean";  window.scrollBy(0,-160);
    }
